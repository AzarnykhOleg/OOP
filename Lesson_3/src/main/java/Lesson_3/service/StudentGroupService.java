...
import Lesson_3.data.StudentComparator;
import Lesson_3.data.StudentGroup;
import Lesson_3.data.Teacher;
...
public class StudentGroupService {
    ...
    public void createStudentGroup(String nameOfGroup, Teacher teacher, List<Student> students) {
        this.studentGroup = new StudentGroup(nameOfGroup, teacher, students);
    }
